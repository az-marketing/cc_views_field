...
<p><strong>Note:</strong> For Arizona residents enrolled in an Arizona Online program, there is a tuition cap at 12 units in Fall and Spring semesters. There is no tuition cap for non-resident students enrolled with Arizona Online. To calculate the cost for additional units beyond this rate table, add the cost per unit (1 unit of TUITION) to the TOTAL for each additional unit.</p>
  </div>
